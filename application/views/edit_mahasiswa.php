...
<head>
    ...
    <title>Edit Nilai - Rekapitulasi Nilai</title>
...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="<?= base_url('dashboard/update/' . $mahasiswa['id']); ?>">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="nilai" name="nilai" value="<?= $mahasiswa['nilai']; ?>"
                    required>
            </div>
